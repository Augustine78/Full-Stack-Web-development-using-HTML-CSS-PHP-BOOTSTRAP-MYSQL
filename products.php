	...
	<body>
		...
		<div class="container panel-margin">
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/22.jpg" alt="shirt">
						<div class="caption">
							<h3>H&W</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/23.jpg" alt="shirt">
						<div class="caption">
							<h3>Luis Phil</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/24.jpg" alt="shirt">
						<div class="caption">
							<h3>John Zok</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/25.jpg" alt="shirt">
						<div class="caption">
							<h3>Jhalsani</h3>
			...
			<div class="row text-center">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/18.jpg" alt="watch">
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/19.jpg" alt="watch">
						<div class="caption">
							<h3>HMT Milan</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/20.jpg" alt="watch">
						<div class="caption">
